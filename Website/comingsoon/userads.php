...
<head>
    ...
    <!-- MachineID: WEB291 -->
    <title>Ad Templates - ROBLOX</title>
        ...
        <div class="content ">
            ...
            <div id="HomeContainer" class="row home-container" data-update-status-url="/home/updatestatus">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>User Ad - Templates</h1>
                        </div>
                        <div class="col-md-9" style="overflow: visible">
                            <h3>Welcome to the ad templates overview!</h3>
                            <p>Pick an ad template from below.</p>

                            <p></p>

                            <a href="/img/userad1.png">
                                <div class="btn-control-md">
                                    <div class="card-body">
                                        <h5 class="card-title">Ad Type #1</h5>
                                        <p class="card-text">Horizontal Shape</p>
                                    </div>
                                </div>
                            </a>
                            <a href="/img/userad2.png">
                                <div class="btn-control-md">
                                    <div class="card-body">
                                        <h5 class="card-title">Ad Type #2</h5>
                                        <p class="card-text">Vertical Shape</p>
                                    </div>
                                </div>
                            </a>
                            <a href="/img/userad3.png">
                                <div class="btn-control-md">
                                    <div class="card-body">
                                        <h5 class="card-title">Ad Type #3</h5>
                                        <p class="card-text">Rectangle Shape</p>
                                    </div>
                                </div>
                            </a>
                        </div>
