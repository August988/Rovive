...
<head>
    ...
    <link rel="stylesheet" href="/css/reset___90041b2af2fb6b9b7864ee66001ba812_m.css">
    <link rel="stylesheet" href="/css/main___23e1cfc4f7f34bdc2ff4f3c2d637a122_m.css">
    <link rel="stylesheet" href="/css/page___a8df4e05745e2f1982052b2df4b09733_m.css">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,requiresActiveX=true" />
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="ROBLOX Corporation" />
    <meta name="description" content="The tech is obsolete and I&#39;m working on other projects with a bunch of front page publishers. Feel free to take it.

Build your factory as you develop and mass produce the most successful series of RPGs in history!" />
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://www.rovive.pro/game-pass/<%= gameid %>/<%= name2 %>" />
    ...
    <meta name="twitter:app:url:iphone" content="r2016mobile://placeID=<%= gameid %>">
    <meta name="twitter:app:name:ipad" content="ROBLOX Mobile">
    <meta name="twitter:app:id:ipad" content="431946152">
    <meta name="twitter:app:url:ipad" content="r2016mobile://placeID=<%= gameid %>">
    <meta name="twitter:app:name:googleplay" content="ROBLOX">
    <meta name="twitter:app:id:googleplay" content="com.rbx2016client">
    <meta name="twitter:app:url:googleplay" content="r2016mobile://placeID=<%= gameid %>" />


    <link href="/img/favicon.ico" rel="icon" />
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600" rel="stylesheet" type="text/css">

    <link rel="canonical" href="https://www.rovive.pro/game-pass/<%= gameid %>/<%= name2 %>" />
...
<script type='text/javascript' src='/js/jquery-1.11.1.min.js'></script>
    ...
    <meta property="al:ios:url" content="r2016mobile://placeID=<%= gameid %>" />
                            ...
                            <div class="rbx-popover-content" data-toggle="popover-setting">
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <% if (role == "approver" || role == "mod" || role == "admin" || role == "owner") { %>
                                        <li><a class="rbx-menu-item"
                                            href="https://www.rovive.pro/admi"><p>Admin</p></a></li>
                                    
                                    <li><a class="rbx-menu-item" href="https://www.rovive.pro/Help/Builderman.aspx"
                                            target="_blank"><p>Help</p></a></li>
                                    <li><a class="rbx-menu-item" href="/logout"><p>Logout</p></a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <div id="RepositionBody">
                <div id="Body" class="body-width">
                                        ...
                                        error: function () {
                                            ...
                                            Roblox.GenericConfirmation
                                                .open({
                                                    ...
                                                    bodyContent: "Failed to remove item.",
                                                    acceptText: "OK",
                                                    acceptColor: Roblox
                                                        .GenericConfirmation
                                                        .blue,
                    ...
                    <div id="ItemContainer" class="text ">
                        <div>
                            <div id="ctl00_cphRoblox_GearDropDown"
                                class="SetList ItemOptions <% if(!owned) { %>invisible"
                                data-isdropdownhidden="True" data-isitemlimited="False" data-isitemresellable="False">
                                <a href="#" class="btn-dropdown">
                                    <img src="/img/ea51d75440715fc531fc3ad281c722f3.png">
                                </a>
                                <div class="clear"></div>
                                    ...
                                    <div class="SetListDropDownList invisible">
                                        <div class="menu invisible">
                                            ...
                                            <div id="ctl00_cphRoblox_ItemOwnershipPanel">
                                                ...
                                                <a id="ctl00_cphRoblox_btnDelete" class=""
                                                    href="javascript:deleteItem()">Delete
                                                    from My Stuff</a>
                        ...
                        <div id="Item">
                            <div id="Details">
                                ...
                                <div id="assetContainer">
                                    <div id="Thumbnail">
                                        ...
                                        <div id="AssetThumbnail" class="thumbnail-holder"
                                            data-reset-enabled-every-page=""
                                            data-url="https://www.rovive.pro/thumbnail/asset?assetId=<%= id %>&amp;thumbnailFormatId=254&amp;width=320&amp;height=320"
                                            style="width:320px; height:320px;">
                                            <span class="thumbnail-span"><img class="" src="<%= icon %>"></span>
                                    ...
                                    <div class="SummaryDetails">
                                        <div id="Creator" class="Creator">
                                            <div class="Avatar">
                                                ...
                                                <a id="ctl00_cphRoblox_AvatarImage" class=" notranslate"
                                                    title="<%= creatorname %>"
                                                    href="https://www.rovive.pro/users/<%= creatorid %>/profile"
                                                    style="display:inline-block;height:70px;width:70px;cursor:pointer;">
                                                    <img src="/api/getProfilePicture?id=<%= creatorid %>"
                                                        height="70" width="70" border="0" alt="<%= creatorname %>"
                                                        class=" notranslate">
                                                    <!--<img
                                                        src="https://www.rovive.pro/img/icons/overlay_obcOnly.png"
                                                        class="bcOverlay" align="left"
                                        ...
                                        <div class="item-detail">
                                            ...
                                            <a id="ctl00_cphRoblox_CreatorHyperLink" class="stat notranslate"
                                                href="https://www.rovive.pro/users/<%= creatorid %>/profile"><%= creatorname %></a>
                                        ...
                                        <div id="ctl00_cphRoblox_DescriptionPanel" class="DescriptionPanel notranslate">
                                            ...
                                            <pre class="Description Full text"
                                                style="position: relative;"> <%= desc %> <div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
                                            <pre class="Description body text"
                                                style="position: relative;"><span class="description-content"><%= desc %></span><span class="description-more-container"></span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

                                        </div>
                                        <div class="ReportAbuse">
                                            <div id="ctl00_cphRoblox_AbuseReportButton1_AbuseReportPanel"
                                                class="ReportAbuse">

                                                <span class="AbuseIcon"><a
                                                        id="ctl00_cphRoblox_AbuseReportButton1_ReportAbuseIconHyperLink"
                                                        href="https://www.rovive.pro/abusereport/asset?id=<%= id %>&amp;RedirectUrl=http%3a%2f%2fwww.rovive.pro%2fitem.aspx%3fseoname%3dTwo-Story-House%26id%3d<%= id %>"><img
                                                            src="/img/abuse.png"
                                                            alt="Report Abuse" style="border-width:0px;"></a></span>
                                                <span class="AbuseButton"><a
                                                        id="ctl00_cphRoblox_AbuseReportButton1_ReportAbuseTextHyperLink"
                                                        href="https://www.rovive.pro/abusereport/asset?id=<%= id %>&amp;RedirectUrl=http%3a%2f%2fwww.rovive.pro%2fitem.aspx%3fseoname%3dTwo-Story-House%26id%3d<%= id %>">Report
                                                        Abuse</a></span>
                                        ...
                                        <div id="ctl00_cphRoblox_GamePassPlacesPanel">

                                            Earn this badge at:

                                            <div class="AssetThumbnail">
                                                <a href="https://www.rovive.pro/games/<%= gameid %>"
                                                    class="item-place-container">
                                                    <img src="<%= gamethumb %>" height="140" width="140">
                                                </a>
                                            </div>
                                            <div class="AssetDetails">
                                                <div class="AssetName notranslate">
                                                    <a id="ctl00_cphRoblox_GamePassPlaceLinksRepeater_ctl00_HyperLink1"
                                                        href="https://www.rovive.pro/item.aspx?id=<%= gameid %>"><%= gamename %></a>
                                                </div>
                                            </div>
                                                ...
                                                <div id="ctl00_cphRoblox_Genres">
                                                    ...
                                                    <div class="GenreInfo stat">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div id="ctl00_cphRoblox_GenresDisplayTest_AssetGenreRepeater_ctl03_AssetGenreRepeaterPanel"
                                                                class="AssetGenreRepeater_Container">

                                                                <div class="GamesInfoIcon <%= gamegenre %>"></div>
                                                                <div><a
                                                                        href="https://www.rovive.pro/"><%= gamegenre %></a>
                                                                </div>
                                        ...
                                        <div class="BuyPriceBox">
                                            ...
                                            <div class="footnote">
                                                ...
                                                <div id="ctl00_cphRoblox_Sold">
                                                    (<span data-se="item-numbersold"><%= sold %></span>
                                                    Won)
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <% if (isCreator){ %>
                                            <div class="BuyPriceBoxContainer">
                                                <div class="BuyPriceBox">
                                                    ...
                                                    <p>&nbsp;</p>
                                                    <form action="/v1/update/item2" method="post">
                                                        <input type="hidden" name="itemId" value="<%= id %>">
                                                        <label for="name">Name:</label>
                                                        <input type="text" class="navbar-search-input" style="width: 99%;" name="name" placeholder="Name" value="<%= name %>">
                                                        <label for="desc0 ">Description:</label>
                                                        <textarea rows="5" cols="50" class="navbar-search-input" style="width: 99%;" name="desc0" id="desc0" placeholder="Description"><%= desc %></textarea>
                                                        <input type="text" class="navbar-search-input" style="width: 99%;" id="desc" name="desc" placeholder="Description" value="<%= desc %>" hidden>
                                                        <script>
                                                            document.querySelector("form").addEventListener("submit", function(e) {
                                                                document.querySelector("#desc").value = document.querySelector("#desc0").value;
                                                            });
                                                        </script>
                                ...
                                <div class="actions">
                                    <div class="voting">
                                        <div class="voting-panel body" data-asset-id="<%= id %>"
                                            data-total-up-votes="<%= likes %>" data-total-down-votes="<%= dislikes %>"
                                            data-vote-modal="" data-user-authenticated="True">
                                            ...
                                            <div class="vote-summary">
                                                <div class="voting-details">
                                                    <div class="total-upvotes divider-right">
                                                        ...
                                                        <span>
                                                            Thumbs up:
                                                            <span class="total-upvotes-text"><%= likes %></span>
                                                        </span>
                                                    </div>
                                                    <div class="total-downvotes">
                                                        <span>
                                                            Thumbs down:
                                                            <span class="total-downvotes-text"><%= dislikes %></span>
                                                        </span>
                                                ...
                                                <div class="visual-container">
                                                    ...
                                                    <div class="percent" style="width: <%- likeratio %>%;"></div>
                                                    <div class="clear"></div>
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                        ...
                                        <script>
                                            $(function () {
                                                ...
                                                Roblox.Voting.Resources = {
                                                    ...
                                                    guestUserMessage: "<div>You must login to vote.</div> <div>Please <a href='/newlogin?returnUrl=%2Fitem.aspx%3Fseoname%3DTwo-Story-House%26id%3D<%= id %>'>login or register</a> to continue.</div>",
                                                    returnUrl: '/newlogin?returnUrl=%2Fitem.aspx%3Fseoname%3DTwo-Story-House%26id%3D<%= id %>',
                            ...
                            <div class="PrivateSales divider-top invisible">
                                ...
                                <div id="UserSalesTab">
                                    ...
                                    <div class="pgItemsForResale">
                                        <span id="ctl00_cphRoblox_pgItemsForResale"><a
                                                disabled="disabled">First</a>&nbsp;<a
                                                disabled="disabled">Previous</a>&nbsp;<a
                                                disabled="disabled">Next</a>&nbsp;<a
                                                disabled="disabled">Last</a>&nbsp;</span>
                                    </div>
                                </div>
                            ...
                            <div id="Tabs">
                                <ul id="TabHeader" class="WhiteSquareTabsContainer">
                                    ...
                                    <li id="RecommendationsTabHeader" contentid="RecommendationsTab"
                                        class="SquareTabGray ItemTabs ">
                                        <span><a id="RecommendationsLink" href="#RecommendationsTab">
                                                Recommendations</a></span></li>

                                    <li id="CommentaryTabHeader" contentid="CommentaryTab"
                                        class="SquareTabGray ItemTabs selected">
                                        <span><a id="CommentaryLink" href="#CommentaryTab">
                                                Commentary</a></span></li>
                                </ul>
                                <div class="StandardPanelContainer">
                                    <div id="RecommendationsTab" class="StandardPanelWhite TabContent ">


                                        <div class="AssetRecommenderContainer">
                                            <table id="ctl00_cphRoblox_AssetRec_dlAssets" cellspacing="0" align="Center"
                                                border="0" style="height:175px;width:800px;border-collapse:collapse;">
                                                <tbody>
                                                    <tr>
                                                        <!-- <td>
                                                            <div class="PortraitDiv"
                                                                style="width: 140px;overflow: hidden;margin:auto;"
                                                                visible="True" data-se="recommended-items-0">
                                                                <div class="AssetThumbnail">
                                                                    <a id="ctl00_cphRoblox_AssetRec_dlAssets_ctl00_AssetThumbnailHyperLink"
                                                                        class=" notranslate" title="Manager Teleporter"
                                                                        href="https://www.rovive.pro/game-pass/"
                                                                        style="display:inline-block;height:110px;width:110px;cursor:pointer;"><img
                                                                            src=""
                                                                            height="110" width="110" border="0"
                                                                            alt="Manager Teleporter"
                                                                            class=" notranslate"></a>
                                                                </div>
                                                                <div class="AssetDetails">
                                                                    <div class="AssetName noTranslate">
                                                                        <a id="ctl00_cphRoblox_AssetRec_dlAssets_ctl00_AssetNameHyperLinkPortrait"
                                                                            href="https://www.rovive.pro/game-pass/">Manager
                                                                            Teleporter</a>
                                                                    </div>
                                                                    <div class="AssetCreator">
                                                                        <span class="stat-label">Creator:</span> <span
                                                                            class="Detail stat"><a
                                                                                id="ctl00_cphRoblox_AssetRec_dlAssets_ctl00_CreatorHyperLinkPortrait"
                                                                                class="notranslate"
                                                                                href="https://www.rovive.pro/users/<%= creatorid %>/profile"><%= creatorname %></a></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td> -->
                                        ...
                                        <script type="text/javascript">
                                            $(function () {
                                                ...
                                                var userNames = $(
                                                    '.PortraitDiv .AssetDetails .AssetCreator .Detail a');
                                    ...
                                    <div id="CommentaryTab" class="StandardPanelWhite TabContent selected">
                                        <div id="ctl00_cphRoblox_CommentsPane_CommentsUpdatePanel">
                                            ...
                                            <div class="AjaxCommentsContainer">
                                                ...
                                                <div class="Comments" data-asset-id="<%= id %>"></div>

                                                <div class="CommentsItemTemplate">
                                                    <div class="Comment text">
                                                        <div class="Commenter">
                                                            <div class="Avatar avatar avatar-headshot-md"
                                                                data-user-id="%CommentAuthorID" data-image-size="small">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="Post">
                                                                <div class="Audit">
                                                                    <span class="ByLine footnote">
                                                                        <div class="UserOwnsAsset"
                                                                            title="User has this item"
                                                                            alt="User has this item"
                                                                            style="display:none;"></div>Posted
                                                                        %CommentCreated ago by <a
                                                                            href="https://www.rovive.pro/users/%25CommentAuthorID/profile">%CommentAuthor</a>
                                                                    </span>
                                                                    <div class="ReportAbuse">
                                                                        <span class="AbuseButton">
                                                                            <a
                                                                                href="https://www.rovive.pro/abusereport/comment?id=%CommentID&amp;redirectUrl=%PageURL">Report
                                                                                Abuse</a>
                                                                        </span>
                                                                    </div>
                                                                    <div style="clear:both;"></div>
                                                                ...
                                                                <div id="Actions" class="Actions">
                                                                    <a data-comment-id="%CommentID"
                                                                        class="DeleteCommentButton">Delete Comment</a>
                                                                </div>
                                                            </div>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            Roblox.commentsPane.Resources = {
                                                ...
                                                emailVerifiedABMessage: "You must verify your email before you can comment. You can verify your email on the <a href='https://www.rovive.pro/my/account?confirmemail=1'>Account</a> page.",
                                            ...
                                            Roblox.commentsPane.FilterRegex =
                                                "(([a-zA-Z0-9-]+\\.[a-zA-Z]{2,4}[:\\#/\?]+)|([a-zA-Z0-9]\\.[a-zA-Z0-9-]+\\.[a-zA-Z]{2,4}))";
                        ...
                        <div class="Ads_WideSkyscraper">
                            ...
                            <iframe name="Roblox_GameDetail_Right_160x600" allowtransparency="true" frameborder="0"
                                height="612" scrolling="no" src="https://www.rovive.pro/user-sponsorship/2" width="160"
