...
<head>
    ...
    <link rel="canonical" href="https://www.rovive.pro/download/thankyou" />
...
<body id="rbx-body" class="" data-performance-relative-value="0.000" data-internal-page-name=""
    ...
    <div class="container-main  
        ...
        <div class="content ">
            ...
            <div class="successful-message-div">
                ...
                <p class="successful-message-description">It’s time to play! You can now browse and play the most
                    popular games on ROBLOX.</p>
                <a href="/games">
                    <button type="button" class="btn-primary-xs">
                        Browse ROBLOX Games
                    </button>
                </a>
            </div>
    ...
    <footer class="container-footer">
        <div class="footer">
            <ul class="row footer-links">
                ...
                <li class="col-4 col-xs-1 footer-link">
                    <a href="http://corp.rovive.pro/parents" class="text-footer-nav roblox-interstitial" target="_blank">
                        Parents
                    </a>
                </li>
                <li class="col-4 col-xs-1 footer-link">
    ...
    <div id="PlaceLauncherStatusPanel" style="display:none;width:300px" data-new-plugin-events-enabled="True"
        ...
        <div class="modalPopup blueAndWhite PlaceLauncherModal" style="min-height: 160px">
            <div id="Spinner" class="Spinner" style="padding:20px 0;">
                <img data-delaysrc="/img/e998fb4c03e8c2e30792f2f3436e9416.gif" height="32" width="32"
                    alt="Progress" />
            </div>
    ...
    <div id="ProtocolHandlerStartingDialog" style="display:none;">
        <div class="modalPopup ph-modal-popup">
            ...
            <div class="ph-logo-row">
                <img data-delaysrc="/img/RoviveLetter.png" width="90" height="90"
                    alt="R" />
            </div>
    ...
    <div id="ProtocolHandlerAreYouInstalled" style="display:none;">
        <div class="modalPopup ph-modal-popup">
            ...
            <div class="ph-areyouinstalleddialog-content">
                ...
                <div class="small">
                    <a href="https://help.rovive.pro/hc/en-us/articles/204473560" class="text-name" target="_blank">Click
                        here for help</a>
                </div>
            </div>
        </div>
    ...
    <div id="videoPrerollPanel" style="display:none">
        ...
        <div id="videoPrerollJoinBC">
            ...
            <a href="https://www.rovive.pro/premium/membership?ctx=preroll" target="_blank" class="btn-medium btn-primary"
                id="videoPrerollJoinBCButton">Join Builders Club</a>
        </div>
    </div>
    <script type="text/javascript">
        $(function () {
    ...
    <script type='text/javascript' src='/js/c55982be90aee588f799ba26ede12190.js'></script>
    ...
    <script type='text/javascript' src='/js/45b2fa0efc7a63d10d3455d19d77646e.js'></script>
    ...
    <script type='text/javascript'>
        ...
        Roblox.config.paths['Pages.Catalog'] = '/js/c14a216bd7773e7b637b4e6c3c2e619d.js';
        Roblox.config.paths['Pages.CatalogShared'] = '/js/4acfdab2e6131feb84d783765b82a888.js';
        ...
        Roblox.config.paths['Widgets.HierarchicalDropdown'] = '/js/3368571372da9b2e1713bb54ca42a65a.js';
        Roblox.config.paths['Widgets.ItemImage'] = '/js/8db82e6d725b907e91441b849cc35e47.js';
    ...
    <script type='text/javascript' src='/js/26f9295091a0eda56a116648d58f9ce3.js'></script>
</body>
