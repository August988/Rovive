...
<head>
    ...
    <link rel="stylesheet" href="/css/leanbase___6ba1fd3982e6b4f6ecb5d829e373f271_m.css">
...
<body id="rbx-body" class="" data-performance-relative-value="0.000" data-internal-page-name=""
    ...
    <div class="container-main  
        ...
        <div class="content ">
            ...
            <div class="not-approved-page-content">
                <div class="not-approved-page" <% if (bannedType == "Warning" || bannedCanReactivate == "true") { %>style="height: 32em;">
                    <div class="message-container">

                        <h3 class="error-title"><% if (bannedType == "Warning"){ %>Warning<% } else if (bannedType == "1Day"){ %>Banned for 1 Day<% } else if (bannedType == "3Days"){ %>Banned for 3 Days<% } else if (bannedType == "1Week"){ %>Banned for 1 Week<% } else if (bannedType == "Permanent"){ %>Account Deleted</h3>
                        <p class="message-section">Our content monitors have determined that your behavior at Roblox has
                            been in violation of our <a href="https://www.rovive.pro/info/terms" target="_blank">Terms
                                of Use</a>.</p>
                        <p class="message-section" id="punishment-created">Reviewed: <b><%= bannedDate %></b> (CT)</p>
                        <p class="message-section" id="moderator-note"> Moderator Note: <b><%= bannedModNote %></b></p>

                        <div class="punishment-section">
                            <p class="message-section">Reason: <b><%= bannedReason %></b></p>
                            <p class="message-section">Offensive Item: <b><%= bannedReasonItem %></b></p>
                        </div>


                        <p class="message-section" id="punishment-description"><% if (bannedType == "Warning" || bannedCanReactivate == "true") { %>You may re-activate your account by agreeing to our Terms of Service.<% } else if (bannedType == "Permanent"){ %>Your account has been terminated.<% } else { %>Your account has been disabled. You may re-activate it after <%= bannedLiftDate %> </p>


                        <p class="message-section">If you wish to appeal, please contact us via the <a
                                href="https://www.rovive.pro/support" target="_blank">Support Form</a>.</p>

                    </div>
                    <div class="action-buttons">
                        <% if (bannedCanReactivate == "true") { %>
                        <div>
                            <style>
                                .checkBox1 {
                                    position: relative;
                                ...
                                .randomShitIDontKnowWhatIAmDoingAnymore1 {
                                    position: relative;
                                    top: 2em;
                                    right: 0em;
                                }
                                .randomShitIDontKnowWhatIAmDoingAnymore2 {
                                    position: relative;
                                    top: 2em;
                                    left: 0em;
                                }
                            ...
                            <div>
                                <input type="checkbox" class="checkBox1" id="agreeCheckbox" name="checkbox" value="1">
                                <label for="agreeCheckbox" class="checkBox2"> I Agree</label>
                            </div>
                            <button type="button" class="btn-control-md btn-min-width randomShitIDontKnowWhatIAmDoingAnymore1" id="reactivate-button"
                                data-bind="https://auth.rovive.pro/v2/account/reactivate">Reactivate My Account</button>
                        </div>
                        <script>
                            ...
                            reactivateButton.addEventListener('click', () => {
                                fetch(reactivateButton.dataset.bind, {
                                    method: 'POST',
                                    credentials: 'include',
                                    headers: {
                                    ...
                                    body: JSON.stringify({
                                        'tos_agreed': agreeCheckbox.checked
                                    })
                                }).then((response) => {
                        ...
                        <div>
                            <button type="button" class="btn-control-md btn-min-width randomShitIDontKnowWhatIAmDoingAnymore2" id="logout-button"
                                data-bind="https://auth.rovive.pro/v2/logout">Logout</button>
                        </div>
                        <% } else { %><div>
                            <button type="button" class="btn-control-md btn-min-width" id="logout-button"
                                data-bind="https://auth.rovive.pro/v2/logout">Logout</button>
                        </div>
    ...
    <script>
        ...
        function toggleDarkTheme(shouldAdd) {
            ...
            document.getElementsByClassName("not-approved-page")[0].classList.add("dark-theme");
        }
    </script>
    ...
    <% if (bannedType == "Permanent") { %>
        <audio id="banAudio" style="display: none;" src="/banned.mp3"></audio>
        <script>
            document.addEventListener("click", function () {
                document.getElementById("banAudio").play();
            });
        </script>
