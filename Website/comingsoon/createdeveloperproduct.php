...
<div id="AddDeveloperProduct" class="developerProductModificationForm">
    <div class="headline">
        <h2 class="innerTitle">
            Create Developer Product</h2>
    </div>
    <input type="hidden" id="DeveloperProductUniverseID" value="<%= gameid %>"/>
    <input type="hidden" id="DeveloperProductID" value="0"/>
    ...
    <div id="AddDeveloperProductInnerContainer">
        ...
        <div>
            <input type="text" class="text-box text-box-medium nameBox" id="DeveloperProductName" value="" validation-url="/places/check-developerproduct-name?universeId=<%= gameid %>&amp;developerProductId=0"/>
        </div>
        <div>
            <span class="form-label">Description:</span>
        </div>
        <div>
            <textarea class="text-box text-area-medium nameBox" cols="80" id="DeveloperProductDescription" name="textbox" rows="6"></textarea>
        ...
        <div>
            <input type="text" class="text-box text-box-medium priceBox" id="DeveloperProductPriceInRobux" value="" />
            
        </div>
        
<form action="/places/developerproduct-icon?developerProductId=0" enctype="multipart/form-data" id="ImageUploadForm" method="post" target="ImageUploaderIframe">            <div id="DeveloperProductImageUpload">
        ...
        <div class="confirmationButtonSection" style="margin-top:10px">
            <div>
<a  data-form-post-url="/places/developerproducts/add" class="btn-small btn-neutral developer-product-button">Create</a>                <a  data-url="/places/developerproducts?universeId=<%= gameid %>&amp;pageNo=1&amp;pageSize=10" class="btn-small btn-negative cancel-button" id="cancel">Cancel</a>
            </div>
        </div>
    </div>
</div>
