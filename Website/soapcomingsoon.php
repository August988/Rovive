...
"Arguments": ["https://www.rovive.pro/asset/?id=' . $placeId . '", "PNG", 1280, 720, "https://www.rovive.pro", ' . $placeId . ']
},
"Arguments": {
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro", "https://www.rovive.pro/v1.1/avatar-fetch?userId=' . $userId . '&placeId=0", "PNG", 768, 768]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro", "https://www.rovive.pro/v1.1/avatar-fetch?userId=' . $userId . '&placeId=1", "PNG", 768, 768, true, 40, 100, 0, 0]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro", "https://www.rovive.pro/v1.1/avatar-fetch?userId=' . $userId . '&placeId=0", "OBJ", 768, 768]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro/asset/?id=' . $assetId . '","https://www.rovive.pro/","OBJ", 720, 720, "https://www.rovive.pro/asset/?id=8246626421", ""]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro/asset/?id=' . $assetId . '","OBJ", 720, 720, "https://www.rovive.pro/", 8246626421]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro/asset/?id=' . $assetId . '","OBJ", 720, 720, "https://www.rovive.pro/"]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro/asset/?id=' . $assetId . '","https://www.rovive.pro/","PNG", 720, 720, "https://www.rovive.pro/asset/?id=235400037", ""]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro/asset/?id=' . $assetId . '","PNG", 720, 720, "https://www.rovive.pro/", 235400037]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
"BaseUrl": "rovive.pro",
"MatchmakingContextId": 1,
"Arguments": ["https://www.rovive.pro/asset/?id=' . $assetId . '","PNG", 720, 720, "https://www.rovive.pro/"]
},
"Arguments": {
"MachineAddress": "127.0.0.1"
}
...
';
            ...
            $scriptText = '
                ...
                "PlaceId": 1,
                "UserId": 1,
                "BaseUrl": "your revival domain here",
                "MatchmakingContextId": 1,
                "Arguments": ["https://your revival domain here/asset/?id=' . $assetId . '","PNG", 720, 720, "https://www.rovive.pro/"]
                },
                "Arguments": {
                "MachineAddress": "127.0.0.1"
                }
...
"JobId":"' . $JobId . '",
"PreferredPort":' . $gamerandomport . ',
"PlaceFetchUrl":"https://www.rovive.pro/asset/?id=' . $placeId . '"
},
"Arguments":{}
}
';
...
function changeableUserThumbnail($userId, $x = 768, $y = 768)
{
    try {
        ...
        $scriptText = '
            ...
            "BaseUrl": "rovive.pro",
            "MatchmakingContextId": 1,
            "Arguments": ["https://www.rovive.pro", "https://www.rovive.pro/v1.1/avatar-fetch?userId=' . $userId . '&placeId=0", "PNG", ' . $x . ', ' . $y . ']
            },
            "Arguments": {
            "MachineAddress": "127.0.0.1"
            }
