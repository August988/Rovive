                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9" style="overflow: visible">
                            <form method="post" action="/jobs/moderator" onSubmit="return validateForm();">
                                ...
                                <span><input type="radio" id="data_6_0" name="data_6" value="Asset moderation"/> Asset moderation</span><br/>
                                <span><input type="radio" id="data_6_1" name="data_6" value="Full Moderator"/> Full Moderator</span><br/>
                                </div>
