...
<head>
    ...
    <link rel="canonical" href="https://www.rovive.pro/users/<%= auserid %>/friends" />


    <link rel='stylesheet'
        href='/css/leanbase___9b9fc145916d65f94e610d1f02775894_m.css' />



    <link rel='stylesheet'
        href='/css/page___60f9a6d2069a06a25ebd1082e30d53cf_m.css' />
...
<body id="rbx-body" class="" data-performance-relative-value="0.000" data-internal-page-name=""
    ...
    <div class="container-main  
        ...
        <div class="content ">
            ...
            <div id="state-properties" data-userid="<%= auserid %>" data-loggedinuserid="<?= $_SESSION["user"]["id"] ?>"
                data-removefriendurl="/api/friends/removefriend" data-acceptfriendurl="/api/friends/acceptfriendrequest"
                data-declinefriendurl="/api/friends/declinefriendrequest"
                data-declineallfriendsurl="/api/friends/declineallfriendrequests" data-followurl="/user/follow"
                data-unfollowurl="/api/user/unfollow" data-unfriendurl="/api/friends/removefriend"
                data-isfriendshiprealtimeupdateenabled=true data-username="<?= htmlspecialchars($_SESSION["user"]["username"]) ?>"></div>


            <div class="row page-content" ng-modules="robloxApp, ui.bootstrap, friends, robloxApp.helpers" ng-cloak
                ...
                <div class="rbx-tabs-horizontal">
                    <ul id="horizontal-tabs" class="nav nav-tabs" role="tablist">
                        <li id="friends" class="rbx-tab"
                            ng-class="{'active': currentData.activeTab == 'friends', 'subtract-item': !currentData.isMyProfile}"
                            ui-sref="friends">
                            <a class="rbx-tab-heading">
                                <span class="text-lead">Friends</span>
                            </a>
                        </li>
                        <li id="following" class="rbx-tab"
                            ng-class="{'active': currentData.activeTab == 'following', 'subtract-item': !currentData.isMyProfile}"
                            ui-sref="following">
                            <a class="rbx-tab-heading">
                                <span class="text-lead">Following</span>
                            </a>
                        </li>
                        <li id="followers" class="rbx-tab"
                            ng-class="{'active': currentData.activeTab == 'followers', 'subtract-item': !currentData.isMyProfile}"
                            ui-sref="followers">
                            <a class="rbx-tab-heading">
                                <span class="text-lead">Followers</span>
                            </a>
                        </li>
                        <li id="requests" class="rbx-tab" ng-show="currentData.isMyProfile"
                            ng-class="{'active': currentData.activeTab == 'friend-requests', 'subtract-item': !currentData.isMyProfile}"
                            ui-sref="friend-requests">
                            <a class="rbx-tab-heading">
                    ...
                    <div class="friends-content" ng-class="{'hide-template': !currentData.templateVisible}">
                        <h3 class="friends-subtitle">{{ currentData.stateLabel }}
                            ({{ friendsContent.friends.data.TotalFriends | number }})</h3>
                        <button
                            ng-show="currentData.activeTab == 'friend-requests' && friendsContent.friends.data.TotalFriends > 0"
                        ...
                        <span class="tooltip-container" data-toggle="tooltip" data-toggle-mobile="true"
                            title="{{ currentData.tooltipLabel }}">
                            <span class="icon-moreinfo"></span>
                        </span>
                        <div class="tab-content rbx-tab-content" ui-view>
                            <ul class="hlist avatar-cards">
                                <li ng-repeat="friend in friendsContent.friends.data.Friends"
                                    class="list-item avatar-card friends-container"
                                    ng-show="friend.UserId && !currentData.ignoreAll && friend.isAvailable">
                                    <div class="avatar-card-container" ng-class="{'disabled': friend.IsDeleted}">
                                        <div class="avatar-card-content">
                                            <div class="avatar-card-fullbody">
                                                <a ng-href="{{friend.AbsoluteURL}}" class="avatar-card-link"
                                                    ng-if="!friend.IsDeleted">
                                                    <img ng-class="{'online': friend.IsOnline && !friend.InGame && !friend.InStudio, 'game': friend.InGame && friend.IsOnline, 'studio': friend.InStudio && friend.IsOnline}"
                                                        class="avatar-card-image" ng-src="{{ friend.AvatarUri }}"
                                                        thumbnail='friend.Thumbnail' image-retry />
                                                </a>
                                                <img ng-if="friend.IsDeleted" class="avatar-card-image"
                                                    ng-src="{{ friend.AvatarUri }}" thumbnail='friend.Thumbnail'
                                                    image-retry />
                                                <div ng-hide="currentData.activeTab == 'followers' || currentData.activeTab == 'friend-requests'"
                                                    ng-if="!friend.IsDeleted">
                                                    <a ng-href="{{ friend.AbsoluteURL}}" class="avatar-status"> <span
                                                            ng-show="friend.IsOnline && !friend.InGame && !friend.InStudio"
                                                            class="icon-online"
                                                            title="{{friend.LastLocation}}"></span></a>
                                                    <a ng-href="{{ friend.AbsolutePlaceURL }}"
                                                        class="avatar-status"><span
                                                            ng-show="friend.InGame && friend.IsOnline" class="icon-game"
                                                            title="{{friend.LastLocation}}"></span></a>
                                                    <div class="avatar-status"><span
                                                            ng-show="friend.InStudio && friend.IsOnline"
                                                            class="icon-studio" title="{{friend.LastLocation}}"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="avatar-card-caption">
                                                <div id="{{ friend.UserId }}" class="text-overflow">
                                                    <a ng-href="{{friend.AbsoluteURL}}" title="{{friend.Username}}"
                                                        ng-if="!friend.IsDeleted"
                                                        class="avatar-name">{{ friend.Username }}</a>
                                                    <span title="{{friend.Username}}" ng-if="friend.IsDeleted"
                                                        class="avatar-name">{{ friend.Username }}</span>
                                                </div>
                                                <div class="avatar-card-label" ng-if="!friend.IsDeleted">
                                                    {{friend.IsOnline ? "Online" : "Offline"}}</div>
                                                <div class="avatar-card-label" ng-if="friend.IsDeleted">User has been
                                                    restricted</div>
                                                <div ng-show="currentData.activeTab == 'friends' || (currentData.activeTab == 'following' && friend.IsFollowed)"
                                                    class="avatar-status-container">
                                                    <div ng-show="friend.IsOnline && !friend.InGame && !friend.InStudio"
                                                        class="avatar-card-label">Website</div>
                                                    <div ng-show="friend.InGame && friend.IsOnline">
                                                        <div class="text-label small">Playing</div>
                                                        <a ng-href="{{ friend.AbsolutePlaceURL }}"
                                                            class="text-link text-overflow avatar-status-link">
                                                            {{ friend.LastLocation }}
                                                        </a>
                                                    </div>
                                                ...
                                                <div ng-show="currentData.activeTab == 'following' && !friend.IsFollowed"
                                                    class="avatar-card-label fail" ng-cloak>Unfollowed</div>
                                            </div>
                                            <div class="avatar-card-menu" card-menu id="{{friend.UserId}}"
                                                ng-if="hasMenu(currentData, friend)">
                                            </div>
                                        </div> <!-- avatar-card-content-->
                                        <div class="avatar-card-btns" ng-show="currentData.hasBtns">
                                            <button type="button" class="btn-control-md ignore-friend"
                                                ng-click="declineFriendRequest(friend.UserId, friend,currentData.currentPage)">Ignore</button>
                                            <button type="button" class="btn-secondary-md accept-friend"
                                                ng-click="acceptFriendRequest(friend.UserId, friend,currentData.currentPage)">Accept</button>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="pager-holder">
                        <ul class="pager" ng-show="currentData.totalPages > 1">
                            <li class="pager-prev" ng-class="{'disabled': (currentData.currentPage /18) + 1 == 1}">
                                <a ng-click="newPage(((currentData.currentPage /18) - 1))"><span
    ...
    <div ng-modules="pageTemplateApp">
        <script type="text/javascript" src="/js/f5375aa9149deb5155ed61cee8bf8be8.js"></script>
    </div>
    ...
    <script type='text/javascript' src='/js/b69491d84fc9989cd460b9d8fba4fb35.js'></script>
