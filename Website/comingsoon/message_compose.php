...
<head>
    ...
    <link rel="canonical" href="https://www.rovive.pro/my/messages" />
    ...
    <script type="text/javascript">
        ...
        Roblox.Endpoints.Urls['/avatar/request-thumbnail-fix'] =
            'https://www.rovive.pro/avatar/request-thumbnail-fix';
        ...
        Roblox.Endpoints.Urls['/thumbnail/remove-asset-media'] =
            'https://www.rovive.pro/thumbnail/remove-asset-media';
                ...
                <div id="navbar-universal-search" class="navbar-left rbx-navbar-search col-xs-5 col-sm-6 col-md-3"
                    ...
                    <ul data-toggle="dropdown-menu" class="dropdown-menu" role="menu">
                        ...
                        <li class="rbx-navbar-search-option"
                            data-searchurl="https://www.rovive.pro/games/?Keyword=">
                            <span class="rbx-navbar-search-text">Search <span class="rbx-navbar-search-string"></span>
                                in Games</span>
                        </li>
                        <li class="rbx-navbar-search-option"
                    ...
                    <div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y"
                        ...
                        <ul>
                            ...
                            <li class="rbx-upgrade-now">
                                <a href="https://www.rovive.pro/premium/membership?ctx=leftnav"
                                    class="btn-secondary-md" id="upgrade-now-button">Upgrade Now</a>
                            </li>
                            ...
                            <div class="container messagesContainer-0-2-33">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-4"><a href="#">Back</a></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 mt-4"><input class="input-0-2-30" readonly=""
                                            value="To: <%= toUsername %>">
                                        <p></p>
                                        <input maxlength="256" class="input-0-2-30 mt-2" id="subject"
                                            placeholder="Subject:">
                                        <p></p>
                                        <textarea maxlength="1000" id="body" class="input-0-2-30 mt-2 textArea-0-2-31"
                                            rows="8" placeholder="Write your message..."></textarea>
                                        <div class="sendWrapper-0-2-32">
                                            <div><button class="btn-0-2-56 continueButton-0-2-27" id="send"
                                                    title="">Send</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        if (res.status === 200) {
                                            ...
                                            Roblox.GenericConfirmation
                                                .open({
                                                    ...
                                                    bodyContent: "Failed to send message.",
                                                    acceptText: "OK",
                                                    acceptColor: Roblox
                                                        .GenericConfirmation
                                                        .blue,
                        ...
                        <div class="unifiedModalContent"
                            ...
                            <div class="GenericModalButtonContainer" style="padding-bottom: 13px">
                                <div style="text-align:center">
                                    <a id="BClink"
                                        href="https://www.rovive.pro/premium/membership?ctx=bc-only-item"
