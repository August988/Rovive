...
<head>
    ...
    <style id="server-side-styles">.imgDesktop-0-2-7 {
      ...
      .cancelButton-0-2-85:hover {
        background: grey!important;
      }
      .continueButton-0-2-86 {
        width: 100%;
      ...
      .inlineWrapper-0-2-94 {
        text-align: center;
      }
      .searchGroupsInput-0-2-95 {
        min-width: 300px;
      }
      </style><style data-jss="" data-meta="Unthemed">
      .container-0-2-88 {
        ...
        <div id="BodyWrapper" class="container-main">
            <div id="RepositionBody">
                ...
                <div id="Body" class="body-width">
                    ...
                    <div class="container groupsContainer-0-2-24">
                        <div class="row">
                            <div class="col-3">
                                <div class="card-0-2-28">
                                    <div class="container-0-2-63">
                                        <div class="row">
                                            <div class="col-12">
                                                <div><button class="btn-0-2-64 buyButton-0-2-58 pt-2 pb-2 font-size-25"
                                                        title="">Create</button></div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                            ...
                            <div class="col-7 ps-0">
                                <div class="card-0-2-28">
                                    <form method="GET" action="/Search/Groups.aspx" autocomplete="off" class="mb-1">
                                        <div class="inlineWrapper-0-2-26">
                                            <div class="inline-0-2-25"><input type="text" class="searchGroupsInput-0-2-27"
                                                    placeholder=" Search All Groups" name="query" autocomplete="off"></div>
                                            <div class="inline-0-2-25 ms-2">
                                                <div class="buttonWrapper-0-2-29"><button class="button-0-2-30 ">Search</button></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div id="Skyscraper-Adp-Right" class="abp abp-container right-abp"><iframe
                                                ...
                                                scrolling="no" src="https://www.rovive.pro/user-sponsorship/2" width="160"
