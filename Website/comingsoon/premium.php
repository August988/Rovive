...
<head>
    ...
    <link rel="canonical" href="https://www.rovive.pro/premium/membership" />
    ...
    <link rel='stylesheet'
        href='/css/MainCSS___58dd044044005dc0e887c80110c9a567_m.css' />

    <link rel='stylesheet'
        href='/css/page___5e340a637183a0d3e92f15ad04285831_m.css' />
...
<script type='text/javascript' src='/js/jquery-1.11.1.min.js'></script>
    ...
    <script type='text/javascript' src='/js/2664b2ea8f5caff5f0d2c3574829d03f.js'></script>
        ...
        <div class="nav-content-inner">
            <div id="MasterContainer">
                ...
                <div>
                    ...
                    <% if (robloxMessage && robloxMessage != "") { %> <div class="alert-info" role="alert"><b>
                            <%= robloxMessage %> </b></div> 
                        ...
                        <div id="RepositionBody">
                            <div id="Body" class="body-width">
                                ...
                                <div id="BCPageContainer">
                                    <div id="UserDataInfo" data-auth="true" data-active-bc="false"></div>
                                    <div class="header">
                                        <span>
                                            <h1>Upgrade to ROBLOX Builders Club</h1>
                                        </span>
                                    </div>
                                            ...
                                            <thead class="product-title">
                                                <tr>
                                                    <td class="center-bold">
                                                        ...
                                                        <img data-attribute="free"
                                                            src="/img/77add140640c3388e6c9603bc5983846.png"
                                                            alt="free" />
                                                    </td>
                                                    <td class="center-bold">
                                                        <h2 class="product-space">Classic</h2>
                                                        <img data-attribute="classic"
                                                            src="/img/ba707f47bb20a1f4804da461fb5d3c31.png"
                                                            alt=" bc" />
                                                    </td>
                                                    <td class="center-bold">
                                                        <h2 class="product-space">Turbo</h2>
                                                        <img data-attribute="turbo"
                                                            src="/img/d7eb3ed186e351d99ce8c11503675721.png"
                                                            alt="tbc" />
                                                    </td>
                                                    <td class="center-bold">
                                                        <h2 class="product-space">Outrageous</h2>
                                                        <img data-attribute="outrageous"
                                                            src="/img/ca1d0aef06c5fc06a2d8b23aea5e20d2.png"
                                                            alt="obc" />
                                                    </td>
                                                </tr>
                                            </thead>
...
">
                                                ...
                                                <tr>
                                                    <td colspan="4">* Signing bonus is for first time membership
                                                        purchase only.</td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="product-cell divider-left">
                                                        <div class="product-cell">
                                                            ...
                                                            <a data-pid="1" data-rank="BC" data-duration="Monthly"
                                                                class="btn-medium btn-primary product-button">$5.95</a>
                                                        </div>
                                                    </td>
                                                    <td class="product-cell divider-left">
                                                        <div class="product-cell">
                                                            ...
                                                            <a data-pid="34" data-rank="TBC" data-duration="Monthly"
                                                                class="btn-medium btn-primary product-button">$11.95</a>
                                                        </div>
                                                    </td>
                                                    <td class="product-cell divider-left">
                                                        <div class="product-cell">
                                                            ...
                                                            <a data-pid="28" data-rank="OBC" data-duration="Monthly"
                                                                class="btn-medium btn-primary product-button">$19.95</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="product-cell divider-left">
                                                        <div class="product-cell">
                                                            ...
                                                            <a data-pid="24" data-rank="BC" data-duration="Annually"
                                                                class="btn-medium btn-primary product-button">$57.95</a>
                                                        </div>
                                                    </td>
                                                    <td class="product-cell divider-left">
                                                        <div class="product-cell">
                                                            ...
                                                            <a data-pid="27" data-rank="TBC" data-duration="Annually"
                                                                class="btn-medium btn-primary product-button">$85.95</a>
                                                        </div>
                                                    </td>
                                                    <td class="product-cell divider-left">
                                                        <div class="product-cell">
                                                            ...
                                                            <a data-pid="33" data-rank="OBC" data-duration="Annually"
                                                                class="btn-medium btn-primary product-button">$129.95</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
...
">
                                    ...
                                    <div class="right-column">
                                        ...
                                        <div id="RightColumnWrapper">
                                            <div class="cell cellDivider">
                                                For billing and payment questions: <span class="SL_swap"
                                                    id="CsEmailLink"><a
                                                        href="/cdn-cgi/l/email-protection#2e474048416e5c414c424156004d4143"><span
                                                            class="__cf_email__"
                                                            data-cfemail="254c4b434a65574a47494a5d0b464a48">[email&#160;protected]</span></a></span>
                                            </div>
                                            <div class="cell cellDivider">
                                                <h3>Buy ROBUX</h3>
                                                <p>ROBUX is the virtual currency used in many of our online games. You
                                                    can also use ROBUX for finding a great look for your avatar. Get
                                                    cool gear to take into multiplayer battles. Buy Limited items to
                                                    sell and trade. You’ll need ROBUX to make it all happen. What are
                                                    you waiting for?</p>
                                                <p>
                                                    <a href="https://www.rovive.pro/upgrades/robux?ctx=upgrade"
                                                        class="btn-medium btn-primary">Buy ROBUX</a>
                                                </p>
                                                <h3>Buy ROBUX with</h3><br /><br />
                                                <a href="https://www.rovive.pro/rixtypin"><img
                                                        src="/img/028e16231452041ab6d702ea467e96dd.png"
                                                        alt="rixty" /></a><br /><br />
                                                <a
                                                    href="https://itunes.apple.com/us/app/roblox-mobile/id431946152?mt=8"><img
                                                        src="/img/70deff83e869746b0bbc41a86f420844.png"
                                                        alt="itunes" /></a>
                                            </div>
                                            <div class="cell cellDivider">
                                                <h3>Game Cards</h3>
                                                <a href="https://www.rovive.pro/gamecards"><img alt="ROBLOX Gamecards"
                                                        src="/img/863c65342816d665de28411cf47cde42.png" /></a>
                                                <div class="gameCardControls">
                                                    <div class="gameCardButton">
                                                        <a href="https://www.rovive.pro/gamecards"
                                                            class="btn-small btn-primary">Where to Buy</a>
                                                    </div>
                                                    <div><a href="https://www.rovive.pro/gamecard"
                                                            class="redeemLink">Redeem Card</a></div>
                                                    <div style="clear: both"></div>
                                                </div>
                                            </div>
                                            <div class="cell">
                                                <h3>Parents</h3>
                                                <p>Learn more about Builders Club and how we help <a
                                                        href="https://corp.rovive.pro/parents"
                                                        class="roblox-interstitial">keep kids safe.</a></p>
                                                <h3>Cancellation</h3>
                                                <p>You can turn off membership auto renewal at any time before the
                                                    renewal date and you will continue to receive Builders Club
                                                    privileges for the remainder of the currently paid period. To turn
                                                    off membership auto renewal, please click the 'Cancel Membership
                                                    Renewal button' on the <a
                                                        href="https://www.rovive.pro/my/account?tab=billing"
                                                        class="roblox-interstitial">Billing</a> tab of the Settings page
                                    ...
                                    <script>
                                        $(function () {
                                            if (GoogleAnalyticsEvents) {
                                                ...
                                                GoogleAnalyticsEvents.FireEvent(['RobuxBcClick',
                                                    'BCButtonClick', ''
                                                ]);
                                            }
                                        });
                        ...
                        <div class="footer">
                            <ul class="row footer-links">
                                <li class="col-4 col-xs-1 footer-link">
                                    <a href="http://corp.rovive.pro" class="text-footer-nav roblox-interstitial"
                                        target="_blank">
                                        About Us
                                    </a>
                                </li>
                                <li class="col-4 col-xs-1 footer-link">
                                    <a href="http://www.rovive.pro/jobs" class="text-footer-nav roblox-interstitial"
                                        target="_blank">
                                        Jobs
                                    </a>
                                </li>
                                ...
                                <li class="col-4 col-xs-1 footer-link">
                                    <a href="http://help.rovive.pro/" class="text-footer-nav roblox-interstitial"
                                        target="_blank">
                                        Help
                                    </a>
                                </li>
                                <li class="col-4 col-xs-1 footer-link">
                                    <a href="https://www.rovive.pro/Info/terms-of-service" class="text-footer-nav"
                                        target="_blank">
                                        Terms
                                    </a>
                                </li>
                                <li class="col-4 col-xs-1 footer-link">
                                    <a href="https://www.rovive.pro/Info/Privacy.aspx" class="text-footer-nav privacy"
                                        target="_blank">
                                        Privacy
                                    </a>
                                </li>
    ...
    <div id="InstallationInstructions" class="modalPopup blueAndWhite" style="display:none;overflow:hidden">
        <a id="CancelButton2" onclick="return Roblox.Client._onCancel();"
            class="ImageButton closeBtnCircle_35h ABCloseCircle"></a>
