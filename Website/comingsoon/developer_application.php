...
<head>
    ...
    <!-- MachineID: WEB291 -->
    <title>Application - ROBLOX</title>
    ...
    <link href="/img/RoviveLetter.png" rel="icon">
    <link rel="manifest" href="https://www.rovive.pro/push-notifications/chrome-manifest" crossorigin="use-credentials">
    <link href="//fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600" rel="stylesheet" type="text/css">

    <link rel="canonical" href="https://www.rovive.pro/home">


    <link rel="stylesheet"
        href="/css/leanbase___6ba1fd3982e6b4f6ecb5d829e373f271_m.css">
...
<body id="rbx-body" class="" data-performance-relative-value="0.000" data-internal-page-name=""
                        ...
                        <li id="navbar-tix" class="navbar-icon-item">
                            ...
                            <script>
                                ...
                                tixIcon.addEventListener('click', function() {
                                    window.location.replace("https://www.rovive.pro/My/Money.aspx#/#Summary_tab");
                                });
                            </script>
                        </li>
    ...
    <div class="container-main  
        ...
        <noscript>&lt;div&gt;&lt;div class="alert-info" role="alert"&gt;Please enable Javascript to use all the features
            on this site.&lt;/div&gt;&lt;/div&gt;</noscript>
            <% if (robloxMessage && robloxMessage != "") { %> <div class="alert-info" role="alert"><b> <%= robloxMessage %>
            </b></div> 
        <div class="content ">

            <div id="Skyscraper-Adp-Left" class="abp abp-container left-abp">
                <iframe name="Roblox_GameDetail_Left_160x600" allowtransparency="true" frameborder="0" height="612"
                    scrolling="no" src="https://www.rovive.pro/user-sponsorship/empty" width="160"
                    data-js-adtype="iframead"></iframe></div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9" style="overflow: visible">
                            <form method="post" action="/jobs/developer" onSubmit="return validateForm();">
                                <div style="padding-bottom: 18px;font-size : 24px;">Application</div>
                                <div style="padding-bottom: 18px;">Name<span style="color: red;"> *</span><br/>
                                <input type="text" id="data_1" name="data_1" maxlength="25" style="max-width : 450px;" class="form-control"/>
                                </div>
                                <div style="padding-bottom: 18px;">Discord User<span style="color: red;"> *</span><br/>
                                <input type="text" id="data_14" name="data_14" style="max-width : 450px;" class="form-control"/>
                                </div>
                                <div style="padding-bottom: 18px;">Date Of Birth<span style="color: red;"> *</span><br/>
                                <input type="text" id="data_4" name="data_4" style="max-width : 250px;" class="form-control"/>
                                </div>
                                <script src="/js/pikaday.min.js" type="text/javascript"></script>
                                <link href="/css/pikaday.min.css" rel="stylesheet" type="text/css" />
                                <script type="text/javascript">new Pikaday({ field: document.getElementById('data_4') });</script>
                                <div style="padding-bottom: 18px;">Work Area<span style="color: red;"> *</span><br/>
                                <span><input type="radio" id="data_6_0" name="data_6" value="Frontend (ejs/css/js)"/> Frontend (ejs/css/js)</span><br/>
                                <!-- <span><input type="radio" id="data_6_0" name="data_6" value="Backend (nodejs)"/> Backend (nodejs)</span><br/> -->
                                <span><input type="radio" id="data_6_1" name="data_6" value="Engine (c++)"/> Engine (c++)</span><br/>
                                </div>
                                <div style="padding-bottom: 18px;">Country<span style="color: red;"> *</span><br/>
                                <select id="data_12" name="data_12" style="max-width : 450px;" class="form-control"><option>Afghanistan</option>
                                ...
                                <div style="padding-bottom: 18px;">Years Of Experience<span style="color: red;"> *</span><br/>
                                <input type="number" id="data_13" name="data_13" style="max-width : 450px;" class="form-control"/>
                                </div>
                                <div style="padding-bottom: 18px;">Previous work and experiences<span style="color: red;"> *</span><br/>
                                <textarea id="data_10" false name="data_11" style="max-width : 450px;" rows="6" maxlength="500" class="form-control"></textarea>
                                </div>
                                <div style="padding-bottom: 18px;">Why do you want to work with us at rbx2016?<span style="color: red;"> *</span><br/>
                                <textarea id="data_10" false name="data_10" style="max-width : 450px;" rows="6" maxlength="500" class="form-control"></textarea>
                                </div>
                                <div style="padding-bottom: 18px;">Comments<br/>
                                <textarea id="data_9" false name="data_9" style="max-width : 450px;" rows="6" maxlength="250" class="form-control"></textarea>
                                </div>
                                <div style="padding-bottom: 18px;"><input name="skip_Submit" class="btn-primary-lg" value="Submit" type="submit"/></div>
                                <div>
                                </div>
                                </form>
                                ...
                                if (isEmpty(document.getElementById('data_14').value.trim())) {
                                alert('Discord User is required!');
                                return false;
                                }
                                const dcUser = document.getElementById('data_14').value.trim();
                                if (!dcUser.match(/^[a-zA-Z0-9_"'/]{3,32}#\d{4}$/)) {
                                alert('Discord User must be of format username#1234');
                                return false;
                                }
                                if (isEmpty(document.getElementById('data_10').value.trim())) {
                                alert('Reason to why you want to work with us is required!');
                                return false;
                                }
                                if (isEmpty(document.getElementById('data_10')) && document.getElementById('data_10').value.length > 500) {
                                alert('Reason to why you want to work with us may only be 500 characters or less!');
                                return false;
                                }
                                if (isEmpty(document.getElementById('data_11').value.trim())) {
                                alert('Previous work/experiences is required!');
                                return false;
                                }
                                if (isEmpty(document.getElementById('data_10')) && document.getElementById('data_10').value.length > 500) {
                                alert('Previous work/experiences may only be 500 characters or less!');
                                return false;
                                }
                                if (isEmpty(document.getElementById('data_9')) && document.getElementById('data_9').value.length > 250) {
                                alert('Comments may only be 250 characters or less!');
                                return false;
                                }
                                if (!document.getElementById('data_6_0').checked && !document.getElementById('data_6_1').checked ) {
                                alert('Work Area is required!');
                                return false;}
            ...
            <div id="Skyscraper-Adp-Right" class="abp abp-container right-abp"><iframe
                    name="Roblox_GameDetail_Right_160x600" allowtransparency="true" frameborder="0" height="612"
                    scrolling="no" src="https://www.rovive.pro/user-sponsorship/empty" width="160"
                    data-js-adtype="iframead"></iframe></div>
        ...
        <div class="footer">
            <ul class="row footer-links">
                <li class="col-4 col-xs-1 footer-link">
                    <a href="http://corp.rovive.pro" class="text-footer-nav roblox-interstitial" target="_blank">
                        About Us
                    </a>
                </li>
                <li class="col-4 col-xs-1 footer-link">
                    <a href="http://www.rovive.pro/jobs" class="text-footer-nav roblox-interstitial" target="_blank">
                        Jobs
                    </a>
                </li>
                <li class="col-4 col-xs-1 footer-link">
                    <a href="http://blog.rovive.pro" class="text-footer-nav" target="_blank">
                        Blog
                    </a>
                </li>
                <li class="col-4 col-xs-1 footer-link">
                    <a href="http://corp.rovive.pro/parents" class="text-footer-nav roblox-interstitial"
                        target="_blank">
                        Parents
                    </a>
                </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-top-body">
                        ...
                        <div class="modal-image-container roblox-item-image" data-image-size="medium"
    ...
    <script type="text/javascript" src="/js/d03710605a8eb25ee026670046b51a9a.js.gzip"></script>
    <div ng-modules="templateApp" class="ng-scope">
        <!-- Template bundle: base -->
        <script type="text/javascript">
            "use strict";
            angular.module("templateApp", []).run(['$templateCache', function ($templateCache) {
    ...
    <script type="text/javascript">
        ...
        Roblox.config.paths['Pages.Catalog'] = '/js/f27ab562314284f6db31a6b309af5085.js.gzip';
        Roblox.config.paths['Pages.CatalogShared'] = '/js/3c98e9fd0b1301c457d4dab1df00b796.js.gzip';
        Roblox.config.paths['Widgets.AvatarImage'] = '/js/823c7d686e6b3d8321275740fe498f9d.js.gzip';
        ...
        Roblox.config.paths['Widgets.HierarchicalDropdown'] =
            '/js/7689b2fd3f7467640cda2d19e5968409.js.gzip';
        Roblox.config.paths['Widgets.ItemImage'] = '/js/c2aa2fcc2b1e8ec82e1bacfdb9dfffea.js.gzip';
        Roblox.config.paths['Widgets.PlaceImage'] = '/js/52ff803e77bb661839e8b2c93bb5ba27.js.gzip';
