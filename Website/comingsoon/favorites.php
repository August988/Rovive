...
<head>
    <!-- MachineID: WEB173 -->
    <title><%= ausername %>&#39;s Favorites - ROBLOX</title>
    ...
    <link rel="canonical" href="https://www.rovive.pro/users/<%= auserid %>/favorites" />
    ...
    <link rel='stylesheet' href='/css/page___638092d31612ebe56f2b07d0b5a457f2_m.css' />
...
<body id="rbx-body" class="" data-performance-relative-value="0.000" data-internal-page-name=""
        ...
        <div class="container-fluid">
            ...
            <div id="navbar-universal-search" class="navbar-left rbx-navbar-search col-xs-5 col-sm-6 col-md-3"
                ...
                <div class="input-group">
                    ...
                    <input id="navbar-search-input" class="form-control input-field" type="text" placeholder="Search"
                        maxlength="120" />
                ...
                <ul data-toggle="dropdown-menu" class="dropdown-menu" role="menu">
                    <li class="rbx-navbar-search-option selected"
                        ...
                        <span class="rbx-navbar-search-text">Search <span class="rbx-navbar-search-string"></span> in
                            People</span>
                    </li>
            ...
            <div class="navbar-right rbx-navbar-right col-xs-4 col-sm-3">
                <ul class="nav navbar-right rbx-navbar-icon-group">
                    <li id="navbar-setting" class="navbar-icon-item">
                        <a class="rbx-menu-item roblox-popover-close" data-toggle="popover" data-bind="popover-setting"
                            data-viewport="#header" data-original-title="" title="">
                    ...
                    <li id="navbar-tix" class="navbar-icon-item">
                        ...
                        <div class="rbx-popover-content" data-toggle="popover-robux">
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="https://www.rovive.pro/My/Money.aspx#/#Summary_tab" id="nav-robux-balance"
                                        class="rbx-menu-item"><%= robux2 %> ROBUX</a></li>
    ...
    <div id="wrap" class="wrap no-gutter-ads logged-in" data-gutter-ads-enabled="false">
        ...
        <div class="container-main  
            ...
            <noscript>&lt;div&gt;&lt;div class="alert-info" role="alert"&gt;Please enable Javascript to use all the features
                on this site.&lt;/div&gt;&lt;/div&gt;<% if (robloxMessage && robloxMessage != "") { %> <div class="alert-info" role="alert"><b> <%= robloxMessage %>
                </b></div> </noscript>
            <div class="content ">
                ...
                <script type="text/javascript">
                    ...
                    Roblox.AssetsExplorerModel = {
                        ...
                        "userId": <%= auserid %>,
                        "jPlayerVersion": "2.9.2",
                        "isOwnPage": true,
                        "absoluteLibraryUrl": "https://www.rovive.pro/develop/library",
                        "absoluteCatalogUrl": "https://www.rovive.pro/catalog",
                        "isLibraryLinkEnabled": true
                    };
                </script>

                <div class="row page-content" ng-modules="robloxApp, ui.bootstrap, assetsExplorer, robloxApp.helpers">
                    <h1>
                        <%= ausername %>&#39;s Favorites
                    </h1>
                    <div class="col-xs-12 rbx-tabs-vertical assets-explorer-main-content ng-cloak"
                        ng-controller="assetsExplorerController">


                        <div class="category-dropdown">
                            <h3>Category</h3>
                            <div class="input-group-btn" dropdown="">
                                <button type="button" dropdown-toggle="" class="input-dropdown-btn"
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li ng-repeat="category in staticData.assetCategories | orderBy: 'name'"
                                        ui-sref="{{ category.name }}">
                                        <a>{{ category.name }}</a>
                                    </li>
                                </ul>
                            </div>
                            <div ng-show="(currentData.category.items.length > 1)"
                                ...
                                <div class="input-group-btn" dropdown="">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li ng-repeat="subcategory in currentData.category.items"
                                            ui-sref="{{ currentData.category.name + '/' + subcategory.name }}">
                        ...
                        <div class="menu-vertical-container category-tabs">
                            <h3>Category</h3>
                            <ul id="vertical-menu" class="menu-vertical" role="menulist"
                                ng-init="currentData.category.name">
                                <li class="menu-option"
                                    ng-repeat="category in staticData.assetCategories | orderBy: 'name'"
                                    ng-class="{'active': currentData.category.name == category.name}"
                                    ui-sref="{{ category.name }}">
                                    ...
                                    <ul ng-show="(category.items.length > 1)" class="menu-secondary">
                                        <li ng-repeat="subcategory in category.items"
                                            ui-sref="{{ category.name + '/' + subcategory.name }}"
                                            ng-click="$event.stopPropagation()" class="menu-secondary-option"
                                            ng-class="{'active': currentData.subcategory.name == subcategory.name}">
                        ...
                        <div class="tab-content rbx-tab-content" id="assetsExplorer"
                            data-exclusivestartpaging-enabled="false" ng-controller="favoritesContentController"
                            ng-include src="'assets-list'"></div>
                    </div>
                </div>
    ...
    <div id="PlaceLauncherStatusPanel" style="display:none;width:300px" data-new-plugin-events-enabled="True"
        ...
        data-is-user-logged-in="True" data-os-name="Windows" data-protocol-name-for-client="idk16-player"
        data-protocol-name-for-studio="idk16-studio" data-protocol-url-includes-launchtime="true"
    ...
    <script type='text/javascript' src='/js/4316394b4e45809fdc2cfee9c19d7b28.js'></script>
    ...
    <div ng-modules="pageTemplateApp">
        <script type="text/javascript" src="/js/746e06e9d04cdf24f891347f3a974458.js"></script>
    </div>
    ...
    <script type='text/javascript' src='/js/a8aef090f62a438673e779c37d322a34.js'></script>
